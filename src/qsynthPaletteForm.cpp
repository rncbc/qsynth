...
void qsynthPaletteForm::nameComboActivated ( const QString& name )
{
	setPaletteName(name);
}
...
bool qsynthPaletteForm::namedPalette ( const QString& name, QPalette& pal )
{
...
void qsynthPaletteForm::saveNamedPalette (
...
void qsynthPaletteForm::deleteNamedPalette ( const QString& name )
{
	if (m_settings) {
		m_settings->beginGroup(ColorThemesGroup);
...
QStringList qsynthPaletteForm::namedPaletteList (void)
{
